...
import mobailApp from "../assets/img/MobileApp.png";
    ...
    <div className="flex justify-center bg-white py-32">
      <div className="flex flex-col text-center md:flex-row md:text-left md:items-center">
        ...
        <div>
          ...
          <div className="flex mt-10 border-[1px] border-[#3F3D56] w-[144px] rounded-lg px-5 py-3 mr-10 active:scale-95 transition-all">
            <img src={googleplay} alt="" />
            <button className="text-[12px] ml-5 ">Google Play</button>
          </div>
          <div className="flex mt-10 border-[1px] border-[#3F3D56] w-[144px] rounded-lg px-5 py-3 active:scale-95 transition-all">
